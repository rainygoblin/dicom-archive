 ...
 */
@Controller  
@RequestMapping(PathConstants.PATH_ROOT)  
public class IndexController {
	...
	public String doGetRoot() throws IOException{
		logger.info("Get the root page request!");
		return ViewConstants.VIEW_INDEX;
	}

	@RequestMapping(value=PathConstants.PATH_INDEX,method=RequestMethod.GET) 
	public String doGetIndex() throws IOException{
